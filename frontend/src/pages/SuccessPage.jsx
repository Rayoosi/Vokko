export default function SuccessPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center text-white px-6">
      ...
      <div className="bg-slate-900 border border-green-500 rounded-3xl p-10 max-w-xl w-full text-center shadow-2xl">
        ...
        <p className="text-slate-400 text-lg mt-6 leading-relaxed">
          Your VIP upgrade was completed successfully.
          Your account has been updated automatically.
        </p>
